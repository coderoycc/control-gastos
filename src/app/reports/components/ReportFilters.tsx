...
export function ReportFilters({
  ...
  const handleApply = () => {
    ...
    // Dejar que se ejecute la validación/aplicación nativa en el hook
    setTimeout(() => {
      onApply();
    }, 0);
  };
            ...
            {calendarOpen && (
              ...
              >
                ...
                <div className="relative w-full max-w-[330px] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-2xl p-2.5 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                  <div className="flex justify-between items-center mb-1.5 pb-1 border-b border-gray-100 dark:border-gray-850">
